    ...
    <section>
        ...
        <div class="bg-white py-6 shadow-subtle rounded-lg">
            ...
            >
                ...
                <div class="w-full md:w-1/4">
                    <input-group
                        input-autocomplete="user_github_username_search"
                        input-class="form-control form-control-short"
                        input-id="user_github_username"
                        input-name="user_github_username"
                        input-placeholder="GitHub Username"
                        input-type="text"
                        :label-hidden="true"
                        label-text="Email"
                        v-model="editableSearchOptions.user_github_username"
                    />
                </div>
            </div>
