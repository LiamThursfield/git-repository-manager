    ...
    >
        ...
        <div class="bg-white py-6 shadow-subtle rounded-lg">
            <div class="block px-6 w-full">
                ...
                <input-group
                    class="mt-4"
                    :error-message="getPageErrorMessage('github_username')"
                    input-autocomplete="github_username"
                    input-id="github_username"
                    input-name="github_username"
                    :input-required="true"
                    input-type="github_username"
                    label-text="GitHub Username"
                    @errorHidden="clearPageErrorMessage('github_username')"
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.formData.github_username = this.profile.github_username;
